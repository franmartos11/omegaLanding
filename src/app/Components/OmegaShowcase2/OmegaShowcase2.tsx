...
const OmegaShowcase2 = () => {
  ...
  return (
    <div
      id="hero"
      className="sm:bg-[url('/bgHome1.png')] bg-[url('/graybg.png')]  bg-no-repeat bg-cover bg-center flex flex-col lg:flex-row items-center justify-center p-2 lg:p-8 min-h-screen"
    >
