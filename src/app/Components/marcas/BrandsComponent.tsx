...
const BrandsComponent = () => {
        ...
        const allBrands = [
          ...
          { name: "LG", logo: "/lgLogo.webp" },
          { name: "Motorola", logo: "/motorolaLogo.webp" },
          ...
          { name: "Biasoni", logo: "/biasoniLogo.webp" },
          { name: "Makita", logo: "/makitaLogo.webp" },
          { name: "Stihl", logo: "/stihlLogo.webp" },
          { name: "Gladiador", logo: "/gladiadorLogo.webp" },
          { name: "Escorial", logo: "/escorialLogo.webp" },
          { name: "Dibra", logo: "/dibraLogo.webp" },
          { name: "Inelro", logo: "/inelroLogo.webp" },
          { name: "Pauna", logo: "/paunaLogo.webp" },
          { name: "Moretti", logo: "/morettiLogo.webp" },
          { name: "Depaolo", logo: "/depaoloLogo.webp" },
          { name: "Neba", logo: "/nebaLogo.webp" },
          { name: "Drean", logo: "/dreanLogo.webp" },
          ...
          { name: "Sacchi", logo: "/sacchiLogo.webp" },
          { name: "Raid", logo: "/raidLogo.webp" },
          { name: "Virulana", logo: "/virulanaLogo.png" },
          { name: "Lysoform", logo: "/lisoform.webp" },
          { name: "Estisol", logo: "/estisolLogo.webp" },
          { name: "Noninos", logo: "/noninosLogo.webp" },
          { name: "Pampers", logo: "/pampersLogo.webp" },
          { name: "Babysec", logo: "/babysecLogo.webp" },
          { name: "Kovalplast", logo: "/kovalplastLogo.webp" },
          { name: "Banplas", logo: "/banplasLogo.webp" },
          { name: "Celpack", logo: "/celpackLogo.webp" },
        ];
